...
typedef struct in6_addr IN6_ADDR, *PIN6_ADDR, FAR *LPIN6_ADDR;
#endif
...
extern BOOL (WINAPI *_GetLogicalProcessorInformationEx) (
    LOGICAL_PROCESSOR_RELATIONSHIP relationship,
...
extern NTSTATUS (NTAPI *_NtQueryInformationProcess) (
    HANDLE ProcessHandle,
...
extern NTSTATUS (NTAPI *_NtQuerySystemInformation) (
...
extern NTSTATUS (NTAPI *_NtSetInformationProcess) (
    HANDLE ProcessHandle,
    DWORD ProcessInformationClass,
    PVOID ProcessInformation,
    DWORD ProcessInformationLength);
...
extern PSTR (NTAPI * _RtlIpv4AddressToStringA) (
    struct in_addr *Addr,
    PSTR S);

#define RtlIpv4AddressToStringA _RtlIpv4AddressToStringA

extern PSTR (NTAPI * _RtlIpv6AddressToStringA) (
    struct in6_addr *Addr,
    PSTR P);

#define RtlIpv6AddressToStringA _RtlIpv6AddressToStringA

extern DWORD (WINAPI * _GetExtendedTcpTable) (
    PVOID pTcpTable,
    PDWORD pdwSize,
    BOOL bOrder,
    ULONG ulAf,
...
extern DWORD (WINAPI * _GetExtendedUdpTable) (
    PVOID pUdpTable,
    PDWORD pdwSize,
    BOOL bOrder,
    ULONG ulAf,
...
extern DWORD (CALLBACK *_GetActiveProcessorCount) (
    WORD GroupNumber);
...
*/
extern ULONGLONG (CALLBACK *_GetTickCount64) (
    void);

#define GetTickCount64 _GetTickCount64

extern NTSTATUS (NTAPI *_NtQueryObject) (
    HANDLE Handle,
...
extern NTSTATUS (WINAPI *_RtlGetVersion) (
    PRTL_OSVERSIONINFOW lpVersionInformation
);

#define RtlGetVersion _RtlGetVersion

extern NTSTATUS (WINAPI *_NtResumeProcess) (
    HANDLE hProcess
);

#define NtResumeProcess _NtResumeProcess
extern NTSTATUS (WINAPI *_NtSuspendProcess) (
    HANDLE hProcess
);
...
extern ULONG (WINAPI *_RtlNtStatusToDosErrorNoTeb) (
    NTSTATUS status
);
